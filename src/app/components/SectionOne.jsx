    ...
    <div className='max-w-[1024px]'>
        <section className='md:flex block gap-20'>
            <div className="max-w-[514px] max-h-[120px] mt-10">
                ...
                <div className="md:flex block gap-4 mt-7 md:space-y-0 space-y-3">
            ...
            <div className='flex gap-4 md:mt-0 mt-[18em]'>
                <Image src='/Mask group.png' height={460} width={340} alt="images" className=""/>
