...
export default function SectionFour() {
  return (
    <section className=''>
        <div className='bg-[#ffe] rounded-[40px] m-auto max-w-[1352px] md:max-h-[360px] h-full md:flex block gap-8 items-center'>
            ...
            <span className='max-w-[514px] max-h-[174px] items-center md:mt-0 mt-5'>
